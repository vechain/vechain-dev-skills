...
description: Solidity smart contract development on VeChainThor with Hardhat. Covers ERC-20, ERC-721, deployment, gas optimization, ABI codegen, libraries, upgradeable contracts.
allowed-tools: []
model: sonnet
license: MIT
metadata:
